...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Storypop AI — AI UGC Creator App" },
      {
        name: "description",
        content: "Turn your ideas into engaging UGC videos with AI. Create, edit and publish AI-powered videos in minutes.",
      },
      { name: "author", content: "Storypop AI" },
      { property: "og:title", content: "Storypop AI — AI UGC Creator App" },
      {
        property: "og:description",
        content: "Turn your ideas into engaging UGC videos with AI.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "theme-color", content: "#7a3aed" },
    ],
    links: [
